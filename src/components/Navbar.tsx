  ...
  return (
    ...
    >
      <div className="container mx-auto px-2 sm:px-4">
        ...
        <div
          className={`${isTabletView ? '' : 'lg:hidden'} fixed inset-0 top-[56px] bg-black/95 backdrop-blur-md transition-transform duration-300 ${
...
const MobileNavLink: React.FC<{ 
  ...
  <Link
    to={to}
    className={`text-white text-lg font-medium w-full text-center py-2 border-b border-gray-800 ${
