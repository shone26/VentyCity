...
const Home: React.FC = () => {
  return (
    <div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <FeatureCard
              ...
              description="Join the EMS, become a firefighter, or work as a mechanic to help the community and earn money."
            />
            <FeatureCard
              icon="🎮"
      ...
      {/* Community Showcase */}
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-purple-900/20 to-black">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-white mb-10 sm:mb-16 px-2">
            OUR COMMUNITY IN ACTION
          </h2>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {Array.from({ length: 6 }).map((_, index) => (
              <div key={index} className="aspect-video overflow-hidden rounded-lg relative group">
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <img
                  src={`/api/placeholder/640/360`}
                  alt="Roleplay screenshot"
      ...
      {/* How to Join CTA */}
      <section className="py-12 sm:py-16 md:py-20 bg-[url('../assets/images/join-bg.jpg')] bg-cover bg-center relative">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              ...
              <a
                ...
                className="px-6 sm:px-8 py-3 bg-white text-purple-900 rounded-lg font-medium hover:bg-gray-100 transition-colors text-sm sm:text-lg"
              >
                Join Discord
              </a>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-8 sm:mt-10">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block px-6 py-3 bg-black/50 backdrop-blur-sm border-2 border-orange-500 text-white rounded-lg font-medium hover:bg-black/70 transition-colors text-sm sm:text-base"
            >
